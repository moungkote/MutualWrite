...
- (instancetype)init {
    self = [super init];
    if (self) {
        _tagTextFont = [UIFont systemFontOfSize:14.0f];
        ...
        _tagCornerRadius = 12.0f;
        _tagSelectedCornerRadius = 12.0f;
        
        _tagBorderWidth = 0.0f;
        _tagSelectedBorderWidth = 0.0f;
        
        _tagBorderColor = [UIColor whiteColor];
        _tagSelectedBorderColor = [UIColor whiteColor];
        
        _tagShadowColor = [UIColor blackColor];
        _tagShadowOffset = CGSizeMake(0.5, 0.5);
        _tagShadowRadius = 0.5;
        _tagShadowOpacity = 0.3f;
        
        _tagExtraSpace = CGSizeMake(10, 10);
        _tagMaxWidth = 0.0f;
    }
    return self;
}
